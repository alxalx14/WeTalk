# This is a modified version of the module SimpleSocketServer adapted to be used within WeTalk.
# The original version can be found here: https://pypi.org/project/SimpleWebSocketServer/ and here: https://github.com/dpallot/simple-websocket-server
